...
function Certificates() {
    return (
        <div>
            ...
            <div className="com">
                <img src={'https://res.cloudinary.com/djpss9cg9/image/upload/v1689330003/Sethu/m7zwmfug9zqutapgonuz.jpg'} alt="Certificate" height={700} width={1100}></img>
            </div>
            <div className="new">
